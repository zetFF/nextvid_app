  ...
  <div className="absolute inset-0 z-0">
   ...
   <div className="relative z-10 mx-auto max-w-5xl px-6 py-24 flex flex-col items-center justify-center">
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
     <span className="inline-flex Ingl mt-54 items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-xs text-white/80">
     ...
     <h1 className="mt-6 relative Bron text-4xl md:text-7xl text-white font-medium tracking-tight leading-tighter">
      ...
      <span
       className="bg-gradient-to-r from-fuchsia-400 via-indigo-400 to-cyan-300 bg-clip-text text-transparent inline-block"
     ...
     <div className="mt-8 flex Ingl flex-wrap items-center justify-center gap-4">
      <a
       href="#generator"
       className="inline-flex tracking-tight text-white items-center gap-2 rounded-2xl bg-gradient-to-r from-fuchsia-500 via-indigo-500 to-cyan-400 px-5 py-3 font-medium text-black"
      >
     ...
     <div className="mt-8 flex Ingl items-center tracking-tight justify-center gap-6 text-xs text-white/60">
